...
import rlbotexample.asset.animation.player.AnimationPlayer;
import rlbotexample.asset.animation.player.AnimationProfileBuilder;
...
public class AnimationTest implements State {
    ...
    public void start(DataPacket input) {
        animationPlayer = new AnimationPlayer(new AnimationProfileBuilder()
                ...
                .withAnimationOffset(() -> new OrientedPosition(new Vector3(2000, 1000, 1000), new Orientation().rotate(new Vector3(Math.PI, 0, 0))))
                .build());
