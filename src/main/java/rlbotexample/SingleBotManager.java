...
import rlbot.manager.BaseBotManager;
import rlbot.manager.BotManager;
import rlbot.manager.BotProcess;
import rlbot.manager.EmptyControls;
...
public class SingleBotManager extends BotManager {
    ...
    private void doRunBot(final Bot bot, final int index, final AtomicBoolean runFlag) {
        ...
        final SingleBotLoopRenderer renderer = SingleBotLoopRenderer.forBotLoop(bot);
        try {
