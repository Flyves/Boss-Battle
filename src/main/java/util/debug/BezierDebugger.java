...
public class BezierDebugger {
    ...
    public static void renderPath(CurveSegment myPath, Color color) {
        ...
        //Create a new rendering group
            ...
            while (bezierIterator.hasNext()) {
                ...
                r.drawLine3d(color, testLastPosition.toFlatVector(), testCurrentPosition.toFlatVector());
            }
        });
    }

    public static void renderPositionControlledByCar(DataPacket input, Color color) {
        RenderTasks.append(r -> {
            ...
            r.drawLine3d(color, input.allCars.get(input.allCars.size() - 1 - input.botIndex).position.toFlatVector(), currentCursorPosition.toFlatVector());
